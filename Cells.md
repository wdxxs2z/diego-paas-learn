...
1.首先它代表cell调解所有来自BBS组件的消息事件，主要是确保BBS组件中Tasks和actuallLrps在容器中的同步，然后是容灾，这个在Converger组件中已经分析到了，主要是容灾实例迁移</br>
...
跟进函数：lrpsToContainers lrps分配容器功能</br>
